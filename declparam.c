 ...
 * PR NRS   :
 *
 * $Id: declparam.c 4627 2008-10-01 16:48:11Z markstro $
 *
   $Revision: 4627 $
        $Log: declparam.c,v $
...
long declparam_u_ (char *mname, char *pname, char *pdimen, char *ptype,
	...
	char *ustr, char *var, ftnlen mnamelen, ftnlen pnamelen, ftnlen pdimenlen, ftnlen ptypelen,
...
*/
	...
	retval = declparam_u(module, name, dimen, type, value,
	    minimum, maximum, descr, help, units, var);
