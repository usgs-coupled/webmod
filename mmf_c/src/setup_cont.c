 ...
 * PR NRS   :
 *
 * $Id: setup_cont.c 4850 2008-12-18 21:06:17Z rsregan $
 *
   $Revision: 4850 $
        $Log: setup_cont.c,v $
...
*/
        ...
        decl_control_string ("lgr_name", "null");
        decl_control_string ("precip_module", "precip");
        decl_control_string ("temp_module", "temp");
        decl_control_string ("et_module", "potet");
        decl_control_string ("srunoff_module", "srunoff");
		...
		/* dfm = delaware flood model */
		decl_control_int_array ("dfm_flag", 1, &lval);
