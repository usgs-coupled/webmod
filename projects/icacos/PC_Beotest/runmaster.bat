...
set "PROJECT_DIR_PATH=C:\Programs\webmod-trunk\pest\ica\PC_Beotest\webmod"
set "PROJECT_DIR=C:\\Programs\\webmod-trunk\\pest\\ica\\PC_Beotest\\webmod"
...
sed "s#@PROJECT_DIR@#%PROJECT_DIR%\\#" %WEB_TPL%\ica.control.tpl > %WEB_SRC%\ica.control
...
sed "s#@PROJECT_DIR@#%PROJECT_DIR%\\#g" %WEB_TPL%\par2par_ica.tpl.tpl > %WEB_SRC%\par2par_ica.tpl

copy %WEB_DAT%\* %WEB_SRC%
rename %WEB_SRC%\ica.statvar.full ica.statvar
...
sed -i "9s/.*/2   .005  4   4  .005   4/" %PROJECT_DIR_PATH%\ica.pst
...
sed -i "13s/.*/19 5e-7/" %PROJECT_DIR_PATH%\ica.pst
