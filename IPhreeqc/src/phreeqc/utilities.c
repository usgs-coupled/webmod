...
static char const rcsid[] = "$RCSfile: utilities.c,v $  $Revision: 2.27 $";
...
#ifdef PHREEQCI_GUI
extern int linenr;
extern int error_msg_gui (const char *err_str);
extern int warning_msg_gui (const char *err_str);
#endif
...
extern int get_charge(char *charge, LDBLE *z);
