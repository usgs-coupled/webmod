...
#ifdef PHREEQC_IDENT
static char const rcsidglobal[] = "$RCSfile: global.h,v $  $Revision: 2.40 $";
#endif
/*
...
int Merge_fprintf(FILE *stream, const char *format, ...);
#if !defined(USE_DEFAULT_FPRINTF)
#define fprintf Merge_fprintf
#endif
#endif
